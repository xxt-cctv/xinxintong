...
app.controller('ctrl', ['$scope', '$http', '$location', function($scope, $http, $location) {
	var id = $location.search().id,
		url = '/rest/cus/cctv/kzrl/nearby?articleid=' + id;
	...
	$http.get('/rest/cus/cctv/kzrl/get?articleid=' + id).success(function(rsp) {
		...
		$http.post('/rest/mi/matter/logAccess?mpid=9f4335dc25ab0a83c04e066793cba286&id=' + id + '&title=' + rsp.data.title + '&type=kzrl-nearby', {
